...
const PROJECTS = [
  {
    ...
    description: [
      "Built a feature prototype that helps travelers compare live rates for a preferred hotel across multiple date combinations in one decision-friendly view. If rates are above the traveler’s budget, they can set a six-hour price alert that automatically checks for updates.",
